...
.defines(function(){
    ...
    MyGame = ig.Game.extend({
        ...
        init: function() {
            ...
            jQuery.getScript(url + '/socket.io/socket.io.js', function() {
                ...
                ig.socket.on('connect', function () {
                    ...
                    // Clear netLights, because if this is a "reconnect",
                    // then we can't trust the current values.
                    ig.game.netLights = {};
        ...
        connectedToServer: function() {
            return (
                typeof ig.socket !== 'undefined' &&
                ig.socket.socket.connected );
        },
